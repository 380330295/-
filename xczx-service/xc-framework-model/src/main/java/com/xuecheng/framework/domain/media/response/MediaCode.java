...
public enum MediaCode implements ResultCode {
    ...
    MERGE_FILE_CHECK_FAIL(false,22005,"合并文件校验失败！"),
    UPLOAD_FILE_REGISTER_CREATE_FOLDER_FAIL(false,22006,"上传文件目录创建失败！"),
    CHUNK_FILE_NOT_EXIST_CHECK(false,22007,"分块文件在系统不存在！"),
    MEDIA_FILE_NOT_EXIST(false,22008,"媒资文件在数据库中不存在!"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,22009,"只允许为叶子结点课程计划选择视频"),
