...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding binding_queue_process_finish_task(@Qualifier("xc_learning_finishaddchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
